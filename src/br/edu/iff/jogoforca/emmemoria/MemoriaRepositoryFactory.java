...
public class MemoriaRepositoryFactory implements RepositoryFactory {
    ...
    public static MemoriaRepositoryFactory getSoleInstance() {
        if (soleInstance == null) soleInstance = new MemoriaRepositoryFactory();
        return soleInstance;
    }

    public JogadorRepository getJogadorRepository() { return MemoriaJogadorRepository.getSoleInstance(); }
    public RodadaRepository getRodadaRepository() { return MemoriaRodadaRepository.getSoleInstance(); }
    public TemaRepository getTemaRepository() { return MemoriaTemaRepository.getSoleInstance(); }
    public PalavraRepository getPalavraRepository() { return MemoriaPalavraRepository.getSoleInstance(); }
}
